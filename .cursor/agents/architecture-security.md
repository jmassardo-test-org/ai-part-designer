...
description: Design system architecture, data models, security controls, and technical specifications. Use proactively when implementing new features or making architectural decisions.
---
...
❌ Adding inline ignore comments (`# noqa`, `# type: ignore`, etc.)
