...
The new Enclosure Generator provides two ways to create custom enclosures:

### AI Mode

Describe your enclosure in natural language and let AI generate the design:

1. Navigate to **Generate** from the main menu
2. Ensure **AI Description** mode is selected
3. Type your description, for example:
   ```
   Electronics enclosure 120x80x50mm with snap-fit lid,
   USB-C port on back, and ventilation on the sides
   ```
4. Click **Generate Enclosure**
5. View the 3D preview and download your files

### Manual Mode

Configure every aspect of your enclosure with precise controls:

1. Navigate to **Generate** → **Manual Config**
2. Set your dimensions:
   - Use presets (Small, Medium, Large, Pi Case, Arduino)
   - Or enter custom values for width, depth, and height
3. Configure walls and corner radius
4. Choose lid type:
   - **Snap-fit** - Lid clicks into place
   - **Screw-on** - Secured with screws
   - **Hinged** - Attached with a hinge
5. Enable ventilation and choose pattern (Slots, Honeycomb, Circular)
6. Add ports and cutouts:
   - USB-C, USB-A, HDMI, Ethernet
   - Power Jack, SD Card, Audio Jack
   - Choose which side for each port
7. Click **Compile Enclosure** to generate

### Download Options

After generation, download your files in multiple formats:

- **STEP** - For CAD software and manufacturing
- **STL** - For 3D printing

Each part (body, lid) is available in both formats.

### Saving to Projects

Save your generated designs for later:

1. After generation, click **Save to Project**
2. Enter a name and optional description
3. The design is saved with all files and the schema for re-editing
