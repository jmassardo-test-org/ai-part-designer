...
export function SaveDesignModal({
  ...
  return (
    ...
    >
      <div className="w-full max-w-lg bg-white dark:bg-gray-800 rounded-xl shadow-xl max-h-[90vh] overflow-hidden">
        {/* Header */}
        <div className="flex items-center justify-between px-6 py-4 border-b dark:border-gray-700">
          <div className="flex items-center gap-3">
            ...
            <h2 id="save-design-title" className="text-lg font-semibold text-gray-900 dark:text-gray-100">
              Save Design
            </h2>
          </div>
          <button
        ...
        <div className="px-6 py-4 space-y-4 overflow-y-auto max-h-[60vh]">
          ...
          {job.result?.thumbnail_url && (
            <div className="flex justify-center">
              <img
                ...
                alt="Design preview"
                className="w-48 h-48 object-contain bg-gray-100 dark:bg-gray-700 rounded-lg"
              />
            </div>
          )}
          ...
          {/* Name */}
          <div>
            <label htmlFor="design-name" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
            ...
            <input
              ...
              className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent disabled:bg-gray-50 dark:bg-gray-700 dark:text-gray-100 dark:disabled:bg-gray-600"
            />
          </div>

          {/* Description */}
          <div>
            <label htmlFor="design-description" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
              Description
            </label>
            <textarea
              ...
              maxLength={2000}
              disabled={isSaving || success}
              className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent disabled:bg-gray-50 dark:bg-gray-700 dark:text-gray-100 dark:disabled:bg-gray-600 resize-none"
            />
          </div>
                  ...
                  {projects.map((project) => (
                    ...
                    >
                      ...
                      <div className="min-w-0">
                        <div className="font-medium text-sm truncate dark:text-gray-100">{project.name}</div>
                ...
                {showCreateProject ? (
                  <div className="flex gap-2">
                    <input
                      ...
                      className="flex-1 px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg text-sm focus:ring-2 focus:ring-primary-500 focus:border-transparent dark:bg-gray-700 dark:text-gray-100"
                      autoFocus
                      onKeyDown={(e) => {
                  ...
                  <button
                    ...
                    disabled={isSaving || success}
                    className="flex items-center gap-2 w-full p-3 border border-dashed border-gray-300 dark:border-gray-600 rounded-lg text-gray-600 dark:text-gray-400 hover:border-gray-400 dark:hover:border-gray-500 hover:text-gray-700 dark:hover:text-gray-300 transition-colors disabled:opacity-50"
                  >
          ...
          <div>
            ...
            <div className="flex gap-2">
              <input
                ...
                className="flex-1 px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg text-sm focus:ring-2 focus:ring-primary-500 focus:border-transparent disabled:bg-gray-50 dark:bg-gray-700 dark:text-gray-100 dark:disabled:bg-gray-600"
                onKeyDown={(e) => {
                  if (e.key === 'Enter') {
                    e.preventDefault();
                    handleAddTag();
            ...
            {tags.length >= 10 && (
              <p className="mt-1 text-xs text-gray-500 dark:text-gray-400">Maximum 10 tags</p>
            )}
          </div>
        </div>

        {/* Footer */}
        <div className="flex items-center justify-end gap-3 px-6 py-4 border-t dark:border-gray-700 bg-gray-50 dark:bg-gray-700">
          <button
            onClick={onClose}
            disabled={isSaving}
            className="px-4 py-2 text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-gray-100 font-medium transition-colors disabled:opacity-50"
          >
            Cancel
          </button>
          <button
