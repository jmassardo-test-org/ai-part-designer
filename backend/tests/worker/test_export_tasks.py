...
class TestConvertCadFormatFunction:
    ...
    def test_convert_with_quality_parameter(self, tmp_path):
        ...
        from app.cad.export import convert_cad_format, ExportQuality
        ...
        result = convert_cad_format(
            source_path, output_path, "stl", quality=ExportQuality.HIGH
        )
...
class TestConvertFormatTask:
    ...
    @pytest.mark.asyncio
    async def test_convert_format_with_mocked_storage(
