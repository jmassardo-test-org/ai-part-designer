...
class TestListComponents:
    ...
    async def test_list_user_components_success(
    ...
    async def test_list_components_with_pagination(
        ...
        response = await client.get(
            "/api/v1/components?page=1&page_size=10",
            headers=auth_headers
        )
...
class TestSearchComponents:
    ...
    async def test_search_components_success(
        self, client: AsyncClient, auth_headers: dict
    ):
        """Should search components by query."""
        response = await client.get(
            "/api/v1/components?search=arduino",
            headers=auth_headers
        )
    ...
    async def test_search_by_category(
        ...
        response = await client.get(
            "/api/v1/components?category=electronics",
            headers=auth_headers
        )
...
class TestCreateComponent:
    ...
    async def test_create_component_unauthenticated(
...
class TestComponentLibrary:
    ...
    async def test_get_library_components(
        self, client: AsyncClient, auth_headers: dict
    ):
    ...
    async def test_get_component_categories(
        self, client: AsyncClient, auth_headers: dict
    ):
...
endsolid TestModel"""
    ...
    @pytest.mark.asyncio
    async def test_upload_3mf_file_success(
        self, client: AsyncClient, auth_headers: dict
    ):
    ...
    @pytest.mark.asyncio
    async def test_upload_pdf_datasheet_success(
        self, client: AsyncClient, auth_headers: dict
    ):
    ...
    @pytest.mark.asyncio
    async def test_upload_metadata_includes_dates(
        self, client: AsyncClient, auth_headers: dict
    ):
