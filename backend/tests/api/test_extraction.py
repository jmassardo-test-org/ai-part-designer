...
class TestExtractionStatus:
    ...
    async def test_get_extraction_status(self, client: AsyncClient):
...
class TestDimensionExtraction:
    ...
    async def test_extract_dimensions_unauthenticated(self, client: AsyncClient):
    ...
    async def test_extract_dimensions_with_image(self, client: AsyncClient, auth_headers: dict):
...
class TestURLExtraction:
    ...
    async def test_extract_url_unauthenticated(self, client: AsyncClient):
        """Should return 401 without authentication."""
        response = await client.post(
    ...
    async def test_extract_url_authenticated(self, client: AsyncClient, auth_headers: dict):
