...
class TestListAssemblies:
    ...
    async def test_list_assemblies_filter_by_project(
        ...
        response = await client.get(
            f"/api/v1/assemblies?project_id={test_project_for_assembly.id}",
...
class TestCreateAssembly:
    ...
    async def test_create_assembly_missing_project(
    ...
    async def test_create_assembly_invalid_project(
        self, client: AsyncClient, auth_headers: dict
    ):
...
class TestGetAssembly:
    ...
    async def test_get_assembly_not_found(
        self, client: AsyncClient, auth_headers: dict
    ):
...
class TestUpdateAssembly:
    ...
    async def test_update_assembly_not_found(
        self, client: AsyncClient, auth_headers: dict
    ):
        """Should return 404 for non-existent assembly."""
        response = await client.put(
...
class TestDeleteAssembly:
    ...
    async def test_delete_assembly_success(
        ...
        test_user, test_project_for_assembly
    ):
    ...
    async def test_delete_assembly_not_found(
        self, client: AsyncClient, auth_headers: dict
    ):
        """Should return 404 for non-existent assembly."""
        response = await client.delete(
