...
class TestDashboard:
    ...
    async def test_get_dashboard_success(self, client: AsyncClient, auth_headers: dict):
...
class TestRecentActivity:
    ...
    async def test_get_recent_designs(self, client: AsyncClient, auth_headers: dict):
        ...
        assert (
            "recent_designs" in data or "designs" in data or "recent" in data or "activity" in data
        )
...
class TestDashboardStats:
    ...
    async def test_get_stats(self, client: AsyncClient, auth_headers: dict):
        ...
        assert (
            "stats" in data
            or "total_designs" in data
            or "design_count" in data
