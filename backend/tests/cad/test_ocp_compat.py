...
class TestOCPCompatPatch:
    ...
    def test_apply_patch_idempotent(self) -> None:
        ...
        result1 = apply_ocp_compat_patch()
        assert is_patched()
...
class TestCADModulesWorkWithPatch:
    ...
    def test_gridfinity_bin_generation(self) -> None:
        ...
        from app.cad import create_box  # Apply patch
    ...
    def test_enclosure_generation(self) -> None:
        ...
        from app.cad import create_box  # Apply patch
        from app.cad.enclosure import EnclosureGenerator, EnclosureConfig
    ...
    def test_cad_v2_compilation(self) -> None:
        ...
        from app.cad_v2.schemas import EnclosureSpec, BoundingBox, Dimension
