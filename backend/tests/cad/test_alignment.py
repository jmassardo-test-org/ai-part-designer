...
class TestBoundingBox:
    ...
    def test_center_property(self):
        ...
        bbox = BoundingBox(
            ...
            x_max=10.0, y_max=20.0, z_max=30.0,
        )
    ...
    def test_center_with_negative_values(self):
        ...
        bbox = BoundingBox(
            x_min=-10.0, y_min=-20.0, z_min=-30.0,
            x_max=10.0, y_max=20.0, z_max=30.0,
        )
    ...
    def test_size_with_offset(self):
        ...
        bbox = BoundingBox(
            x_min=5.0, y_min=10.0, z_min=15.0,
            x_max=15.0, y_max=30.0, z_max=45.0,
        )
...
class TestAlignmentService:
    ...
    def test_translate_shape_with_cadquery(self):
        ...
        from build123d import Box, Part, Compound
    ...
    def test_align_to_origin(self):
        ...
        from build123d import Box, Part, Compound, Pos
...
class TestAlignmentEdgeCases:
    ...
    def test_tiny_bounding_box(self):
        ...
        bbox = BoundingBox(
            x_min=0.0001, y_min=0.0001, z_min=0.0001,
            x_max=0.0002, y_max=0.0002, z_max=0.0002,
        )
    ...
    def test_large_bounding_box(self):
        ...
        bbox = BoundingBox(
            x_min=-1e6, y_min=-1e6, z_min=-1e6,
            x_max=1e6, y_max=1e6, z_max=1e6,
        )
