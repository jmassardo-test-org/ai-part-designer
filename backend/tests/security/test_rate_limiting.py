...
class TestRateLimiting:
    ...
    async def test_login_rate_limit_headers(self, client: AsyncClient):
        ...
        any(h.lower() in [k.lower() for k in headers] for h in rate_limit_headers)
    ...
    @pytest.mark.asyncio
    async def test_rapid_requests_handled(self, client: AsyncClient, auth_headers: dict):
    ...
    @pytest.mark.asyncio
    async def test_api_endpoints_accept_requests(self, client: AsyncClient, auth_headers: dict):
...
class TestAbusePrevention:
    ...
    @pytest.mark.asyncio
    async def test_unicode_handling(self, client: AsyncClient, auth_headers: dict):
