...
class TestXSSPrevention:
    ...
    @pytest.mark.asyncio
    async def test_xss_in_search_query(self, client: AsyncClient, auth_headers: dict):
    ...
    @pytest.mark.asyncio
    async def test_xss_in_user_input_fields(self, client: AsyncClient, auth_headers: dict):
    ...
    @pytest.mark.asyncio
    async def test_xss_in_design_names(self, client: AsyncClient, auth_headers: dict):
    ...
    @pytest.mark.asyncio
    async def test_content_type_header(self, client: AsyncClient, auth_headers: dict):
