...
def generate_gridfinity_baseplate(
    ...
    **_kwargs: Any,
    ...
    # Create outer shell
    result = Box(outer_x, outer_y, base_thickness, align=(Align.CENTER, Align.CENTER, Align.MIN))
...
def generate_gridfinity_bin(
    ...
    **_kwargs: Any,
    ...
    # Create outer shell
    result = Box(outer_x, outer_y, outer_height, align=(Align.CENTER, Align.CENTER, Align.MIN))
    ...
    if base_fillet > 0:
        base_edges = result.edges().filter_by(Axis.Z).filter_by(lambda e: e.center().Z < 0)
        if base_edges:
            with contextlib.suppress(Exception):
    ...
    if stacking_lip:
        ...
        # Outer lip shell
        lip_outer = Box(
            outer_x, outer_y, STACKING_LIP_HEIGHT, align=(Align.CENTER, Align.CENTER, Align.MIN)
    ...
    if scoop:
        ...
        scoop_cyl = (
            Cylinder(scoop_radius, outer_y, align=(Align.CENTER, Align.CENTER, Align.MIN))
