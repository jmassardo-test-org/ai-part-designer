    ...
    "properties": {
        ...
        "features": {
            ...
            "items": {
                "type": "object",
                "properties": {
                    "type": {"type": "string", "enum": ["hole", "fillet", "chamfer", "slot", "pocket", "boss", "gasket", "flange"]},
        ...
        "assembly_config": {
            ...
            "properties": {
                ...
                "screw_size": {"type": "string", "description": "Metric screw size (M2, M3, M4, etc.)"},
                "has_gasket": {"type": "boolean", "description": "Whether to include gasket groove"},
                "has_flanges": {"type": "boolean", "description": "Whether to include mounting flanges"},
...
TEMPLATE_SELECTION_SCHEMA = {
    ...
    "properties": {
        "template_id": {
            "type": "string",
            "description": "ID of the matching template"
        },
        "parameters": {
            "type": "object",
            "description": "Parameters to apply to the template"
        },
        "confidence": {
            "type": "number",
            "minimum": 0,
    ...
    "properties": {
        "modifications": {
            ...
            "items": {
                "type": "object",
                "properties": {
                    "operation": {"type": "string", "enum": ["resize", "add_feature", "remove_feature", "move", "rotate", "fillet", "chamfer"]},
                    "target": {"type": "string"},
                    "parameters": {"type": "object"}
                }
            }
