        ...
        async with async_session_maker() as session:
            ...
            try:
                ...
                try:
                    ...
                    await _fail_job(
                        job_repo, session, job_id, user_id,
                ...
                fmt = (
                    ExportFormat.STL if export_format.lower() == "stl"
                ...
                try:
                    ...
                    return {"success": False, "errors": [f"Export failed: {str(e)}"]}
        ...
        async with async_session_maker() as session:
            ...
            try:
                ...
                try:
                    ...
                    await _fail_job(
                        job_repo, session, job_id, user_id,
                        f"AI schema generation failed: {str(e)}"
                    )
                    return {"success": False, "errors": [str(e)]}
                ...
                if result.clarification_needed:
                    ...
                    if user_id:
                        send_job_progress(
                            user_id, job_id, 20, "needs_clarification",
