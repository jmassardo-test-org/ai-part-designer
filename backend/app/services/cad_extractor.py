...
class STEPExtractor:
    ...
    def extract(self, step_path: Path) -> CADExtraction:
        ...
        try:
            ...
            return self._create_empty_result(f"STEP extraction error: {str(e)}")
...
class STLExtractor:
    ...
    def extract(self, stl_path: Path) -> CADExtraction:
        ...
        try:
            ...
            return self._create_empty_result(f"STL extraction error: {str(e)}")
    ...
    def _calculate_volume(self, mesh_data) -> Optional[float]:
