...
class Dimensions(BaseModel):
    ...
    notes: Optional[str] = Field(default=None, description="Additional dimension notes")
...
class MountingHole(BaseModel):
    ...
    depth: Optional[float] = Field(default=None, description="Hole depth (None=through)")
    ...
    # Reference
    label: Optional[str] = Field(default=None, description="Hole label from datasheet")
    from_corner: Optional[str] = Field(
        default=None,
...
class MountingPattern(BaseModel):
    ...
    spacing_x: Optional[float] = Field(default=None, description="X spacing between holes")
    spacing_y: Optional[float] = Field(default=None, description="Y spacing between holes")
    unit: LengthUnit = Field(default=LengthUnit.MM)
...
class Connector(BaseModel):
    ...
    # Additional info
    pin_count: Optional[int] = Field(default=None, description="Number of pins")
    label: Optional[str] = Field(default=None, description="Label from datasheet")
...
class ThermalProperties(BaseModel):
    ...
    # Temperature ratings
    min_operating_temp: Optional[float] = Field(
        default=None,
        description="Minimum operating temperature (°C)",
    )
    max_operating_temp: Optional[float] = Field(
        default=None,
        description="Maximum operating temperature (°C)",
    )
    
    # Heat dissipation
    typical_power_consumption: Optional[float] = Field(
        default=None,
        description="Typical power consumption (W)",
    )
    max_power_consumption: Optional[float] = Field(
        default=None,
        description="Maximum power consumption (W)",
    )
    heat_dissipation: Optional[float] = Field(
        default=None,
    ...
    # Airflow
    airflow_direction: Optional[str] = Field(
        default=None,
...
class ElectricalProperties(BaseModel):
    ...
    # Power requirements
    input_voltage_min: Optional[float] = Field(default=None, description="Min input voltage (V)")
    input_voltage_max: Optional[float] = Field(default=None, description="Max input voltage (V)")
    input_voltage_typical: Optional[float] = Field(default=None, description="Typical input voltage (V)")
    
    input_current_typical: Optional[float] = Field(default=None, description="Typical current (A)")
    input_current_max: Optional[float] = Field(default=None, description="Max current (A)")
    
    # Logic levels
    gpio_voltage: Optional[float] = Field(default=None, description="GPIO voltage level (V)")
...
class ComponentSpecifications(BaseModel):
    ...
    mounting_pattern: Optional[MountingPattern] = Field(
        default=None,
    ...
    # Properties
    thermal: Optional[ThermalProperties] = Field(default=None)
    electrical: Optional[ElectricalProperties] = Field(default=None)
...
class CADExtraction(BaseModel):
    ...
    # Mesh info (for STL)
    vertex_count: Optional[int] = Field(default=None)
    face_count: Optional[int] = Field(default=None)
    
    # Analysis
    is_watertight: bool = Field(default=True)
    has_internal_geometry: bool = Field(default=False)
    estimated_volume: Optional[float] = Field(default=None, description="Volume in mm³")
...
class MechanicalDrawing(BaseModel):
    ...
    scale: Optional[str] = Field(default=None, description="Drawing scale if specified")
...
class DatasheetExtraction(BaseModel):
    ...
    # Dimension table
    dimension_table: Optional[dict] = Field(
        default=None,
