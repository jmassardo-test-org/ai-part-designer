...
async def create_organization(
    ...
    await log_org_action(
        db, org.id, current_user.id, "organization_created",
...
async def update_organization(
    ...
    await log_org_action(
        db, org_id, current_user.id, "organization_updated",
...
async def delete_organization(
    ...
    await log_org_action(
        db, org_id, current_user.id, "organization_deleted",
    )
...
async def change_member_role(
    ...
    await log_org_action(
        db, org_id, current_user.id, "member_role_changed",
...
async def remove_member(
    ...
    await log_org_action(
        db, org_id, current_user.id, "member_removed",
        resource_type="member", resource_id=member_id,
    )
...
async def transfer_ownership(
    ...
    await log_org_action(
        db, org_id, current_user.id, "ownership_transferred",
...
async def invite_member(
    ...
    await log_org_action(
        db, org_id, current_user.id, "member_invited",
...
async def revoke_invite(
    ...
    await log_org_action(
        db, org_id, current_user.id, "invite_revoked",
...
async def accept_invite(
    ...
    await log_org_action(
        db, invite.organization_id, current_user.id, "invite_accepted",
        resource_type="invite", resource_id=invite.id,
    )
